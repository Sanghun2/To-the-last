...
public abstract class SelectionRunnerDataBase
{
    ...
    public SelectionRunnerDataBase(int requireMinutes, string displayText, Define.RequirementType requirementType, Ingredient requirement) {
