...
public class DestroyStructureButton : ButtonBase
{
    protected override void ButtonAction() {
        var popUpData = new InfomationPopUpData(
            ...
            new ActionData($"철거({Managers.Construction.GetStructure(Managers.Construction.CurrentLocationIndex)?.StructureContext.ConstructionTime})분", () => Managers.Construction.DestroyCurrentStructure())
        });
